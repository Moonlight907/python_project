...
max_bcg_2021_value = -1  # Начальное значение для поиска максимума, чтобы оно точно было меньше любого значения из таблицы
min_bcg_2021_value = float('inf')  # Начальное значение для поиска минимума (максимально большое число - бесконечность)
